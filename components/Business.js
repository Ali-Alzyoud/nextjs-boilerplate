  ...
  return (
    <div>
        <article className={styles.business}>
            ...
            <div className={`${styles.business__icon} business__icon--dark`}>
            ...
            {locale === 'ar-AR'? (
                <div className={styles.business__content}>
                    <h2 className={`${styles.business__title} business__title--dark`}>كيورا للأعمال</h2>
                    <p className={styles.business__description}>حزمة من خدمات الرفاهية النفسية المدعومة للموظفين.</p>
                </div>
            ) : (
                <div className={styles.business__content}>
                    <h2 className={`${styles.business__title} business__title--dark`}>Cura for Business</h2>
